      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center md:text-left">
            <img src="/avatars/roam.webp" alt="ROAM Logo" width={112} height={112} loading="lazy" decoding="async" className="mx-auto md:mx-0 h-28 mb-4" />
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8">
            <div className="text-center">
              <img src="/avatars/sam.webp" alt="Sam" width={96} height={96} loading="lazy" decoding="async" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
              <h3 className="text-xl font-semibold">Sam</h3>
            </div>
            <div className="text-center">
              <img src="/avatars/david.webp" alt="David" width={96} height={96} loading="lazy" decoding="async" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
              <h3 className="text-xl font-semibold">David</h3>
            </div>
            <div className="text-center">
              <img src="/avatars/jake.webp" alt="Jacob" width={96} height={96} loading="lazy" decoding="async" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
