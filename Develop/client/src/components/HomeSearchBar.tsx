        ...
        <div className="flex flex-col justify-center w-screen md:w-full">
            <div className="relative">
                <button
                    ...
                    className="w-full p-3 rounded-3xl border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-gray-500 text-lg text-center flex items-center justify-center"
                >
                ...
                {isDropdownOpen && (
                    <div className="absolute z-10 w-full md:w-2/3 bg-white border border-gray-300 rounded-lg shadow-lg max-h-[16rem] overflow-y-auto">
